...
constexpr f64 G{0.99};
constexpr f64 B{0.98};
...
int main() {
    ...
    for (int i{1}; i + 1 != idx; ++ i) {
        ...
        qwq::Worth expectTomorrow(1,
            getWorth[i + 1].getGold() + 0,
            getWorth[i + 1].getBitcoin() + 0);
